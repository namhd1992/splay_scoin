				...
				<Grid container className="checkin-root" spacing={12} >
					<Grid item xs={12} md={12}>
						<Grid item xs={12} style={{margin:15}}>
							<div style={{float:'left'}}><img style={{width:24, height:24, marginRight:10}} src="../icon_diemdanh.png" alt="icon"/></div><span style={{float:'left'}}>Điểm danh</span>
						</Grid>
							...
							{data[0].map((obj, key) => (
								<Grid className="checkin-item-wrap" key={key} item xs={4} sm={2}>
									<div style={{height:height}} className='checkin-item'>
										...
										<div className="checkin-day" style={{marginBottom:marginB, marginTop:marginT}}>{"Ngày " + obj.day}</div>
